...
def Itemsformulario(request):
      if request.method == 'POST':
            ...
            if form.is_valid(): 
                  ...
                  pochoclos = informacion['pochoclos'],
...
def itemseditar(request, items_nom):
      ...
      if request.method == 'POST':
            ...
            if form.is_valid:  # Si pasó la validación de Django
                  ...
                  item.pochoclos = informacion['pochoclos']
...
class itemscreacion(PermissionRequiredMixin, CreateView):
      ...
      fields = ["nombre","tipo","pochoclos","descripcion","imagen"]
...
class resenascambiar(LoginRequiredMixin, UpdateView):
      permission_required = 'accounts.template_all'
      model = resenas
      success_url = reverse_lazy("listaresenas")
      fields = ["puntaje","titulo","mensaje","imagen"]

class resenasborrar(LoginRequiredMixin, DeleteView):
      permission_required = 'accounts.template_all'
      model = resenas
      success_url = reverse_lazy("listaresenas")